...
// days2mdhms converts the day of the year, epochDays, to the equivalent month day, hour, minute and second.
...
// JDay calculates the julian date given year, month, day, hour, minute and second
...
// GSTimeFromDate calculates GST given year, month, day, hour, minute and second
...
// LatLongDeg convert LatLong in radians to LatLong in degrees
...
// ThetaG_JD calculate GMST from Julian date.
...
// LLAToECI converts latitude, longitude and altitude(km) into equivalent Earth Centered Intertial coordinates(km)
